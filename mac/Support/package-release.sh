...
- Start or stop a recording with ⌥⇧S, or use ⌥⇧C to drag over part of the screen, press Space to choose a window, save the screenshot to the Library, and copy its public link when signed in with Polyform.
