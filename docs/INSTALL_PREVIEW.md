...
Alpha 4 adds a searchable local walkthrough library. Historical recordings can be replayed, reopened in the visual editor, and downloaded again as a fresh PDF. It also adds an in-product release check while trusted automatic distribution is being completed.

## Chrome

1. Download `JesSee-Chrome-v0.1.0-alpha.4.zip` from the [GitHub prerelease](https://github.com/polyform-ai/jessee/releases/tag/v0.1.0-alpha.4).
...
1. Download `JesSee-Safari-v0.1.0-alpha.4.zip` from the [GitHub prerelease](https://github.com/polyform-ai/jessee/releases/tag/v0.1.0-alpha.4). Do not unzip it.
